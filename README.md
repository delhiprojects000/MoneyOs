...
Every image below is from a real running instance with the demo account seeded. They follow your GitHub theme automatically.

<table>
  <tr>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/01-dashboard.jpg">
        <img src="./docs/screenshots/light/01-dashboard.jpg" alt="Dashboard showing balances, spending trend and upcoming dues" loading="lazy">
      </picture>
      <p align="center"><b>Dashboard</b><br><sub>Balances, this month's trend, and everything due in the next 15 days.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/02-transactions.jpg">
        <img src="./docs/screenshots/light/02-transactions.jpg" alt="Transaction ledger grouped by day with category tags" loading="lazy">
      </picture>
      <p align="center"><b>Transactions</b><br><sub>The full ledger, grouped by day, searchable and filterable.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/03-accounts.jpg">
        <img src="./docs/screenshots/light/03-accounts.jpg" alt="Account cards including a credit card with its statement cycle" loading="lazy">
      </picture>
  ...
  <tr>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/04-reports.jpg">
        <img src="./docs/screenshots/light/04-reports.jpg" alt="Reports with income versus expense bars and a category donut chart" loading="lazy">
      </picture>
      <p align="center"><b>Reports</b><br><sub>Income against expense and spend by category, over any range.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/05-budgets.jpg">
        <img src="./docs/screenshots/light/05-budgets.jpg" alt="Budget cards with progress bars, one over its limit in red" loading="lazy">
      </picture>
      <p align="center"><b>Budgets</b><br><sub>Per-category limits, with overspend called out rather than clipped.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/06-goals.jpg">
        <img src="./docs/screenshots/light/06-goals.jpg" alt="Savings goals with progress and required monthly contribution" loading="lazy">
      </picture>
  ...
  <tr>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/07-emis-loans.jpg">
        <img src="./docs/screenshots/light/07-emis-loans.jpg" alt="Loan list showing lender, monthly EMI and next due instalment" loading="lazy">
      </picture>
      <p align="center"><b>EMIs and loans</b><br><sub>Full amortisation schedules, with the next instalment on the card.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/08-subscriptions.jpg">
        <img src="./docs/screenshots/light/08-subscriptions.jpg" alt="Subscription list with autopay badges and a paused row" loading="lazy">
      </picture>
      <p align="center"><b>Subscriptions</b><br><sub>Recurring spend, with autopay handled and pausing supported.</sub></p>
    </td>
    <td width="33%" valign="top">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/09-bill-reminders.jpg">
        <img src="./docs/screenshots/light/09-bill-reminders.jpg" alt="Bill reminders including an overdue and a settled row" loading="lazy">
      </picture>
...
<br>
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/dark/10-settings.jpg">
  <img src="./docs/screenshots/light/10-settings.jpg" alt="Settings with profile, theme mode, accent palette and category management" loading="lazy">
</picture>
</details>

## Responsive layout

The same screens at 390px and 820px wide. The sidebar collapses into a sheet, stat tiles stack two-up, and the quick-add button stays reachable with a thumb.

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./docs/screenshots/responsive/responsive-dark.jpg">
  <img src="./docs/screenshots/responsive/responsive-light.jpg" alt="MoneyOS at mobile and tablet widths" loading="lazy">
</picture>
